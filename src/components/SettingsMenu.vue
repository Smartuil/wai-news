        ...
        <div class="settings-menu" @click.stop>
          ...
          <div class="settings-content">
            ...
            <div class="setting-item">
              <label>关于</label>
              <div class="about-content">
                <p class="about-description">感谢使用歪脖子，这是一个有趣好玩的歪脖子新闻，希望它对你能有所帮助。</p>
                <div class="links-section">
                  <a href="https://github.com/Smartuil/wai-news" target="_blank" class="link-item">
                    <img src="/icons/code.svg" alt="Source Code" />
                    <span>查看源码</span>
                  </a>
                  <a href="https://x.com/Smartuil" target="_blank" class="link-item">
                    <img src="/icons/x.svg" alt="X" />
                    <span>在 X 上关注作者</span>
                  </a>
                  <a href="https://www.bonan.online/" target="_blank" class="link-item">
            ...
            <div class="setting-item">
              ...
              <div class="about-content">
                ...
                <div class="qr-section">
                  <div class="qr-item">
                    <img src="https://unrealenginelibrary-1252512735.cos.ap-guangzhou.myqcloud.com/image/202512052225915.png" alt="Donation QR Code" />
                  </div>
                </div>
                <div class="support-options">
                  <a href="https://www.bonan.online/Sponsor" target="_blank" class="link-item">
                    <img src="/icons/github.svg" alt="GitHub Sponsors" />
                    <span>GitHub Sponsors</span>
                  </a>
                  <a href="https://buymeacoffee.com/smartuil" target="_blank" class="link-item">
                    <img src="/icons/bmc.svg" alt="buymeacoffee" />
